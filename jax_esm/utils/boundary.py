...
class BoundaryConditionTranslator:
    ...
    def _register_default_transformations(self):
        ...
        self.register_transformation(
            "atmosphere", "ocean", "wind_stress", self._compute_wind_stress
        )
        self.register_transformation(
            "atmosphere", "ocean", "heat_flux", self._atmosphere_to_ocean_heat
        )
        ...
        self.register_transformation(
            "atmosphere", "land", "radiation", self._split_radiation
        )
