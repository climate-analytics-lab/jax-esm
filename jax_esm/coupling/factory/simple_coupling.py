...
def couple_atm_ocn_lnd(
    ...
    forcing_mapper.add_transformation(
        ...
        surface_flux_name,
        "flux.total_heat_flux",
        interpolators["atm_to_lnd_hfluxn"],
    )
    ...
    forcing_mapper.add_transformation(
        "lnd",
        "atm",
        "prog.land_surface_temperature",
        "scalar.land_surface_temperature",
        interpolators["lnd_to_atm"],
    )
...
def generate_atm_lnd_interpolators(
    ...
    if atm_domain.grid_specification.grid_type in [
        "JCM",
        "Veros",
    ] and lnd_domain.grid_specification.grid_type in ["JCM", "Veros"]:
        ...
        def lnd_to_atm(in_array):
            return conditional_transpose(
                interpolator_lnd_to_atm.apply_scalar(
                    conditional_transpose(in_array, not lnd_latlon)
                ),
                not atm_latlon,
            )
