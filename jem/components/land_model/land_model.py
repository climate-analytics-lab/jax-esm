...
class LandModel(Component):
    ...
    def __init__(
        ...
        super().__init__(
            CoupledComponentConfig(name="LandModel", timestep=timestep)
        )
    ...
    def _initialize_fields(self):
        ...
        # Get latitude/longitude for idealized fields
        lat_dim_idx = next(
            i
    ...
    def _create_step_function_body(self):
        ...
        def step_function(state, forcing, t):
            ...
            new_state = state.copy(
                ...
                phydata_kwargs = dict(
                    heatflx = heatflx.astype(jnp.float32),
    ...
    def predictions_to_xarray(
        ...
        Args:
            predictions: Dictionary with 'prog', 'phydata', and 'forcing' fields from model run
        ...
        ds = xr.Dataset(
            data_vars = dict(
                ...
                heatflx = (T_grid_dims, phydata.heatflx, {
                    "long_name": "Surface heat flux into land",
                    "units": "W m-2",
                    "positive": "downward",
                }),
                snowd = (T_grid_dims, phydata.snowd, {
                    "long_name": "Snow depth (water equivalent)",
                    "units": "mm",
                }),
                soilw = (T_grid_dims, phydata.soilw, {
